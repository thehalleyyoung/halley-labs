...
- Monte Carlo-calibrated phase classifier using empirical chi_1 distribution
...
class MeanFieldAnalyzer:
    ...
    Lyapunov exponent computation, and Monte Carlo-calibrated phase
    ...
    def _classify_phase_calibrated(self, chi_1_inf: float, chi_1_fw: float,
        ...
        """Classify phase using Monte Carlo-calibrated posterior probabilities.

        Key improvements over the original classifier:
        ...
        # Bayesian posterior with asymmetric window and finite-width noise
