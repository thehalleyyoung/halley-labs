...
```bash
git clone <repo-url>
cd algebraic-repair-calculus/proposals/proposal_00/implementation
pip install -e ".[dev]"
```
...
```python
from arc.types import Schema, Column, SQLType, ParameterisedType, QualityConstraint
...
|---|---|---|
| Acyclic (>90% of real pipelines) | Dynamic programming | O(\|V\| · k²) |
| General | LP relaxation + rounding | (ln k + 1)-approximation |
